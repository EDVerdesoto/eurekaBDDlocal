-- =============================================
-- SCRIPT DE INICIALIZACION GLOBAL
-- EurekaBank - Todas las Bases de Datos
-- MariaDB 10.11 Compatible
-- =============================================

-- =============================================
-- BASE 1: EurekaBank SOAP Java
-- =============================================
CREATE DATABASE IF NOT EXISTS eurekabank_soap_java
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE eurekabank_soap_java;
...
SELECT 'Base de datos eurekabank_soap_java inicializada exitosamente!' AS Mensaje;

-- =============================================
-- BASE 2: EurekaBank SOAP .NET
-- =============================================
...
-- =============================================
-- BASE 3: EurekaBank REST Java
-- =============================================
CREATE DATABASE IF NOT EXISTS eurekabank_rest_java
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE eurekabank_rest_java;
...
SELECT 'Base de datos eurekabank_rest_java inicializada exitosamente!' AS Mensaje;

-- =============================================
-- BASE 4: EurekaBank REST .NET
-- =============================================
CREATE DATABASE IF NOT EXISTS eurekabank_rest_dotnet
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE eurekabank_rest_dotnet;
...
SELECT 'Base de datos eurekabank_rest_dotnet inicializada exitosamente!' AS Mensaje;
