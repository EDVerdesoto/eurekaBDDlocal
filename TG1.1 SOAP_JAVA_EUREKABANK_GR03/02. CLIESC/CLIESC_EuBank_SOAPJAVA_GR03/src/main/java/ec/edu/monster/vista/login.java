...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Background.add(lblSullivan, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 40, 50, 50));

        btnEntrar.setBackground(new java.awt.Color(0, 128, 190));
        ...
        btnExit.setBackground(new java.awt.Color(153, 214, 234));
        ...
        Background.add(lblSullivan1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 290, 330));

        lblTarea1.setBackground(new java.awt.Color(255, 255, 255));
        lblTarea1.setFont(new java.awt.Font("Britannic Bold", 1, 22)); // NOI18N
        lblTarea1.setForeground(new java.awt.Color(0, 128, 190));
        lblTarea1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblTarea1.setText("<html>+ SOAP</html>");
        lblTarea1.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        Background.add(lblTarea1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 110, 30));

        jPanel1.setBackground(new java.awt.Color(241, 248, 250));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(logoeubank, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        Background.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 450, 400));

        lblTarea.setBackground(new java.awt.Color(255, 255, 255));
        lblTarea.setFont(new java.awt.Font("Britannic Bold", 0, 16)); // NOI18N
        lblTarea.setForeground(new java.awt.Color(0, 128, 190));
    ...
    private void lblExitMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblExitMouseExited
        btnExit.setBackground(new Color(153,214,234));
    ...
    private void lblButtonIniciarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonIniciarMouseEntered
        btnEntrar.setBackground(new Color(0, 76, 113));
    ...
    private void lblButtonIniciarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonIniciarMouseExited
        btnEntrar.setBackground(new Color(0, 128, 190));
    ...
    private void lblButtonIniciarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonIniciarMouseClicked
        ...
        try {
            // ¡USA EL SERVICIO QUE RECIBIMOS!
            // (Ya no necesitas 'new LoginServiceClient()' ni 'new EuBankService()')
            if (this.euBankService.iniciarSesion(usuario, clave)) {
