...
public class Home extends javax.swing.JFrame {
    ...
    int xMouse, yMouse;
    public Home(EuBankService euBankService) {
        this.euBankService = euBankService;
        initComponents();
        
        Clients c = new Clients(euBankService);
        c.setSize(680, 570);
        c.setLocation(0, 0);
    ...
    private void initComponents() {
        ...
        btn_exit.setBackgroundColor(new java.awt.Color(255, 153, 0));
        btn_exit.setBorder(null);
        btn_exit.setBorderColor(new java.awt.Color(255, 153, 0));
        ...
        Menu.setBackground(new java.awt.Color(255, 247, 235));

        lblLogoEu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/EuBank2.png"))); // NOI18N

        btn_clients.setBackgroundColor(new java.awt.Color(255, 153, 0));
        btn_clients.setBorder(null);
        btn_clients.setBorderColor(new java.awt.Color(255, 153, 0));
        btn_clients.setBorderRadius(0);
        btn_clients.setBorderThickness(0);
        btn_clients.setHoverColor(new java.awt.Color(178, 107, 0));
        ...
        btn_movements.setBackgroundColor(new java.awt.Color(255, 153, 0));
        btn_movements.setBorder(null);
        btn_movements.setBorderColor(new java.awt.Color(255, 153, 0));
        btn_movements.setBorderRadius(0);
        btn_movements.setBorderThickness(0);
        btn_movements.setHoverColor(new java.awt.Color(178, 107, 0));
        ...
        btn_exitsession.setBackgroundColor(new java.awt.Color(255, 153, 0));
        btn_exitsession.setBorder(null);
        btn_exitsession.setBorderColor(new java.awt.Color(255, 153, 0));
        btn_exitsession.setBorderRadius(0);
        btn_exitsession.setBorderThickness(0);
        btn_exitsession.setHoverColor(new java.awt.Color(178, 107, 0));
    ...
    private void btn_clientsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_clientsActionPerformed
        Clients c = new Clients(this.euBankService);
        c.setSize(680, 570);
        c.setLocation(0, 0);
    ...
    private void btn_movementsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_movementsActionPerformed
        Movements c = new Movements(this.euBankService);
        c.setSize(680, 570);
        c.setLocation(0, 0);
