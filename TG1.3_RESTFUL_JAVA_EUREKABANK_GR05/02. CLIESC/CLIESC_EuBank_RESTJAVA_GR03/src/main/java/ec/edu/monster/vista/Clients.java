...
public class Clients extends javax.swing.JPanel {
     ...
     */
    public Clients(EuBankService euBankService) {
    ...
    private void initComponents() {
        ...
        tableClients.setEvenRowColor(new java.awt.Color(250, 244, 235));
        tableClients.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        tableClients.setHeaderBackground(new java.awt.Color(255, 153, 0));
        tableClients.setHoverRowColor(new java.awt.Color(255, 204, 153));
