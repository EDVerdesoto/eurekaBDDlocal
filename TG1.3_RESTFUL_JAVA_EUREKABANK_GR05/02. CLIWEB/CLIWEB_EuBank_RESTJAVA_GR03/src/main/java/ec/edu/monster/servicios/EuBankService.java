...
import ec.edu.monster.controladores.DashboardController;
...
public class EuBankService {
    ...
    public List<MovimientoData> traerMovimientos(String cuenta) {
        ...
        // 1. Formato ISO del servidor: yyyy-MM-dd o yyyy-MM-ddZ
    ...
    public ResultadoOperacion regMovimiento(DashboardController.CrearMovimientoRequest request) throws HttpClientErrorException {
        String url = API_BASE_URL + "/movimientos";
